                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">User Daftar</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">User Order</p>
                          <h4 class="card-title">{{ $uniqueUsers }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Order Masuk</p>
                          <h4 class="card-title">{{ $belumDikonfirmasiCount }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Order Progres</p>
                          <h4 class="card-title">{{ $dikonfirmasiCount }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Order kendala</p>
                          <h4 class="card-title">{{ $terkendalaCount }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <h4 class="card-title">{{ $selesaiCount }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          @foreach ($orderan as $orderan)
                              <tr>
                                  <th scope="row">
                                      ...
                                      Payment from {{ $orderan->order_id }}
                                  </th>
                                  <td class="text-end">{{ \Carbon\Carbon::parse($orderan->tanggal_dipesan)->format('M d, Y, h:ia') }}</td>
                                  <td class="text-end">${{ number_format($orderan->total, 2) }}</td>
                                  <td class="text-end">
                                      @if($orderan->status_pembayaran == 'dibayar')
              ...
              <div class="col-md-4">
                <div class="card card-primary card-round">
                    <div class="card-header">
                        ...
                        <div class="card-category">Sales Summary</div>
                    </div>
                    <div class="card-body pb-0">
                        <div class="mb-4 mt-2">
                            <h1>${{ number_format($dailySales->sum('total_sales'), 2) }}</h1>
                        </div>
                        <div class="pull-in">
